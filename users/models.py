...
class Profile(models.Model):
    ...
    gender = models.CharField(
        max_length=11,
        choices=MyModel.ProfileGender.choices,
        default=MyModel.ProfileGender.UNN,
    )
...
class Baby(models.Model):
    ...
    baby_gender = models.CharField(
        max_length=11,
        choices=MyModel.BabyGender.choices,
        default=MyModel.BabyGender.UNN,
    )
    baby_weight = models.CharField(
        max_length=7, choices=MyModel.Weight.choices, default=MyModel.Weight.UNN
    )
    baby_height = models.CharField(
        max_length=7, choices=MyModel.Height.choices, default=MyModel.Height.UNN
    )
